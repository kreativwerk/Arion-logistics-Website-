...
- Design: helles Apple-Style-System (Tokens in `app/globals.css`), ein Akzent (#0a5cff), eine bewusste dunkle Sektion (Digital). Vor UI-Arbeit die Skills unter `.claude/skills/` laden (design-taste-frontend, impeccable).
