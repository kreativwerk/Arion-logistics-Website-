...
export default async function ContactPage({
  ...
  return (
    <div className="mx-auto max-w-[880px] px-6 pb-24 pt-28 md:px-12 md:pt-40">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <div data-reveal data-reveal-delay="0.08" className="rounded-3xl border border-line bg-surface p-7 md:p-9">
          ...
          <a
            ...
            className="mt-4 inline-flex h-11 items-center gap-2 rounded-full bg-accent px-6 text-[14px] font-semibold text-white transition-colors hover:bg-[#e07f00]"
          >
        ...
        <div data-reveal data-reveal-delay="0.16" className="rounded-3xl border border-line bg-surface p-7 md:p-9">
          <h2 className="text-[13px] font-medium uppercase tracking-[0.16em] text-muted">
            {dict.contact.addressLabel}
          </h2>
          <p className="mt-3 text-xl font-medium tracking-tight md:text-2xl">Arion Logistics GmbH</p>
        ...
        <div data-reveal data-reveal-delay="0.24" className="rounded-3xl border border-line bg-surface p-7 md:p-9">
          <h2 className="text-[13px] font-medium uppercase tracking-[0.16em] text-muted">
