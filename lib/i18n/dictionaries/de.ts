...
const de: Dict = {
  ...
  about: {
    ...
    body: [
      ...
      "100 Mitarbeitende aus vielen Ländern, über 75 Transporter und ein eigenes In-house-Team für Recruiting und Marketing: Wir wachsen aus eigener Kraft, komplett digital gesteuert.",
    ],
  },
  process: {
